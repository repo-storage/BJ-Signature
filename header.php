...
<!--        <link rel="stylesheet" type="text/css" media="all" href="<?php echo get_template_directory_uri().'/library/css/wp.css' ?>" />-->
        ...
        <link rel="stylesheet" href="<?php echo cwp::locate_in_library('stylesheet.css', 'fonts/Droid-Sans'); ?>"/>
        <link rel="stylesheet" href="<?php echo cwp::locate_in_library('stylesheet.css', 'fonts/Droid-Serif'); ?>"/>
        <link rel="stylesheet" href="<?php echo cwp::locate_in_library('stylesheet.css', 'fonts/web-symbols'); ?>"/>
        <link rel="stylesheet" href="<?php echo cwp::locate_in_library('stylesheet.css', 'fonts/Entypo'); ?>"/>
